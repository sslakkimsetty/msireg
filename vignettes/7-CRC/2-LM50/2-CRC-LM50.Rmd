---
title: "Co-registration for the CRC LM50 image"
...
# CURRPATH <- "9-CRC"
# 
# opt_filename <- "a_met_LM51- HE.png"
...
DATAPATH <- "/Users/lakkimsetty.s/Documents/9-data"
CURRPATH <- "9-CRC"
load(file.path(DATAPATH, CURRPATH, "processed-in-R/mse-peaks-LM51.RData"))
```
...
save.image("~/Documents/1-saved-envs/vignettes/7-2-CRC-LM50.RData") 
WriteTransform(OUT$reg$TF, "/Users/lakkimsetty.s/Library/Mobile Documents/com~apple~CloudDocs/01-NU/phd/msireg/data/saved-transforms/7-2-CRC-LM50-xyz.hdf5")
```
...
# library("devtools")
# load_all()
# load("~/Documents/1-saved-envs/vignettes/7-2-CRC-LM50.RData")
# OUT$reg$TF <- ReadTransform("data/saved-transforms/7-2-CRC-LM50-xyz.hdf5")
...
mse_roi_ss_x <- applyTransformOnMask(opt_roi_ss, out$reg$TF) 
