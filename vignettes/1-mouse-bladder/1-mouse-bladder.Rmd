---
title: "Co-registration of mouse bladder dataset"
author: "Sai Srikanth Lakkimsetty, Kylie Ariel Bemis, and Melanie Christine Föll"
date: "Jan, 2023"
output:
...
In this vignette, we illustrate the co-registration between phospholipid imaging of a mouse urinary bladder tissue and H&E stained microscopic image. The dataset is publicly available via [PRIDE](https://www.ebi.ac.uk/pride/archive/projects/PXD001283) and [MassIVE](https://massive.ucsd.edu/ProteoSAFe/dataset.jsp?task=117f527a97e3401baec21ecf050c6f99). This dataset is notable for its high mass resolution, visually identifiable local distortions between MS image and its optical (microscopic) counterpart. 
...
```{r, coreg-write-to-file, eval=FALSE, echo=FALSE} 
save.image("~/Documents/1-saved-envs/vignettes/1-mouse-bladder.RData") 
WriteTransform(OUT$reg$TF, "/Users/lakkimsetty.s/Library/Mobile Documents/com~apple~CloudDocs/01-NU/phd/msireg/data/saved-transforms/1-mouse-bladder.hdf5")
```
...
# library("devtools")
# load_all()
# load("~/Documents/1-saved-envs/vignettes/1-mouse-bladder.RData")
...
opt_roi_ss_x <- applyTransformOnMask(opt_roi_ss, out$reg$TF) 
D_postreg <- diceCoefFromMasks(mse_roi_ss, opt_roi_ss_x) 
```
...
# Exploring registration components
