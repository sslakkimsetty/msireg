---
title: "Co-registration for the Harnblase TMA1 image"
...
opt_filename <- "HE_stained_TMA1.tiff"
...
# load(file.path(DATAPATH, CURRPATH, "10-1-harnblase-TMA1.RData"))
```
...
#              file.path(DATAPATH,
#                        "0-processed-in-R/10-1-harnblase-TMA1.imzML"))
```
...
set.seed(2)
ssc <- spatialShrunkenCentroids(mse_peaks, r=c(1), s=c(15), k=c(15), 
...
save.image("~/Documents/1-saved-envs/vignettes/10-1-harnblase-TMA1.RData") 
print(getwd())
WriteTransform(OUT$reg$TF, "/Users/lakkimsetty.s/Library/Mobile Documents/com~apple~CloudDocs/01-NU/phd/msireg/data/saved-transforms/10-1-harnblase-TMA1.hdf5")
```
